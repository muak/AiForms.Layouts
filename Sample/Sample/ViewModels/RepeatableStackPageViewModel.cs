...
namespace Sample.ViewModels
{
    public class RepeatableStackPageViewModel
    {
        ...
        public ObservableCollection<MainPageViewModel.Hoge> BoxList{get;}

        public RepeatableStackPageViewModel(INavigationService navigationService, IPageDialogService pageDlg)
        {
            BoxList = new ObservableCollection<MainPageViewModel.Hoge>(Shuffle());
        ...
        List<MainPageViewModel.Hoge> Shuffle()
        {
            var list = new List<MainPageViewModel.Hoge>();
            ...
            for (var i = 0; i < 8; i++) {
                ...
                list.Add(new MainPageViewModel.Hoge {
                    Name = $"#{r:X2}{g:X2}{b:X2}",
                    Color = color,
                    Width = w,
                    Height = h,
        ...
        MainPageViewModel.Hoge GetNextItem()
        {
            var rand = new Random();
            var r = rand.Next(10, 245);
            var g = rand.Next(10, 245);
            ...
            return new MainPageViewModel.Hoge {
                Name = $"#{r:X2}{g:X2}{b:X2}",
                Color = color,
                Width = w,
                Height = h,
